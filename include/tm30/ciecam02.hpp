...
struct ViewingConditions {
  // TM-30-20 §3.7
  double Yb = 20.0;    // Background luminance (cd/m²)
  ...
  // TM-30-20 §3.7
  double LA = 100.0;    // Luminance of adapting field (cd/m²)
...
///  12. CAM02-UCS J', a', b'
///
/// @param xyz_white   Adapting white point XYZ (10° observer).
/// @param xyz_samples Array of 99 CES sample XYZ values.
///
/// @return Array of 99 Cam02Ucs values.
///
/// TM-30-20 §3.7.1
std::array<Cam02Ucs, 99> ciecam02_forward(
    const XyzTriple& xyz_white,
