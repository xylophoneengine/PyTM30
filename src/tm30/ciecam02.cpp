...
// TM-30-20 viewing conditions (TM-30-20 S3.7).
//
// TM-30-20 S3.7: Color Space and Chromatic Adaptation Transformation
// TM-30-20 S3.7.1: Procedure
...
// -------------------------------------------------------------------------
// Fixed viewing condition parameters (TM-30-20 S3.7)
// -------------------------------------------------------------------------
...
// -------------------------------------------------------------------------
// Derived constants (TM-30-20 S3.7)
// -------------------------------------------------------------------------
...
// -------------------------------------------------------------------------
// CAT02 matrix MCAT02 (Eq. 30, TM-30-20 S3.7.1)
// -------------------------------------------------------------------------

// Row 0: [0.7328,  0.4296, -0.1624]
// TM-30-20 S3.7.1 Eq. (30)
...
// -------------------------------------------------------------------------
// Combined matrix M = MHPE * MCAT02^(-1)  (Eq. 34-35, TM-30-20 S3.7.1)
//
// Precomputed from:
...
// -------------------------------------------------------------------------
// Step 4 constants (TM-30-20 S3.7.1 Eq. (36)-(38))
// -------------------------------------------------------------------------
...
// -------------------------------------------------------------------------
// Step 6 constant (TM-30-20 S3.7.1 Eq. (44))
// -------------------------------------------------------------------------
...
// -------------------------------------------------------------------------
// Step 7 constants (TM-30-20 S3.7.1 Eq. (41))
// -------------------------------------------------------------------------

// TM-30-20 S3.7.1 Eq. (41)
...
// -------------------------------------------------------------------------
// Step 11 constants (TM-30-20 S3.7.1 Eq. (42)-(43))
// -------------------------------------------------------------------------
...
// TM-30-20 S3.7.1 Eq. (43) - FL exponent for M
inline constexpr double kMExpFL = 0.25;

// -------------------------------------------------------------------------
// Step 12 constants (TM-30-20 S3.7.1 Eq. (48), (51))
// -------------------------------------------------------------------------

// TM-30-20 S3.7.1 Eq. (48)
...
// -------------------------------------------------------------------------
// Step 4: luminance-level adaptation (Eq. 36-38, TM-30-20 S3.7.1)
//
...
// -------------------------------------------------------------------------
// Precomputed (1.64 - 0.29^n)^0.73  (Eq. 42, TM-30-20 S3.7.1)
// -------------------------------------------------------------------------
