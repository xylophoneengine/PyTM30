...
YuvTriple xyz_to_Yuv(double X, double Y, double Z) {
  // TM-30-20 S3.1: denominator X + 15Y + 3Z (shared with CIE 1960 UCS).
  ...
  return YuvTriple{
      ...
      4.0 * X /
          denom, // TM-30-20 S3.1 / CIE 15:2004 S8.2.1: u' = 4X / (X + 15Y + 3Z)
      9.0 * Y /
          denom // TM-30-20 S3.1 / CIE 15:2004 S8.2.1: v' = 9Y / (X + 15Y + 3Z)
  };
}
